...
var btn = document.getElementById("cancelar"); // capiturando o botão cancelar


btn.addEventListener('click', function(){ // adiciona o evento de click no botao
